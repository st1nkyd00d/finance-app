-- =============================================
-- RPC: create_transfer (transferencia atómica)
-- Ejecuta débito + crédito + vinculación en una sola transacción DB
-- =============================================
...
DECLARE
  ...
  v_in_id UUID;
BEGIN
  -- Insertar transacción de salida (débito)
  INSERT INTO transactions (
    user_id, wallet_id, category_id, type, amount, currency,
    conversion_rate, amount_usd, description, date
  ) VALUES (
    p_user_id, p_from_wallet_id, NULL, 'transfer_out', p_amount_out,
    p_currency_out, p_conversion_rate, p_amount_usd_out, p_description, p_date
