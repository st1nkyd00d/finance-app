...
import { HiExclamationTriangle, HiChartBar } from 'react-icons/hi2'
    ...
    <div>
        ...
        <div className="mb-6 space-y-2">
          {exceededCount > 0 && (
            <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg px-4 py-3 flex items-center gap-3">
              <HiExclamationTriangle className="w-5 h-5 text-red-500 shrink-0" />
          ...
          {warningCount > 0 && (
            <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-lg px-4 py-3 flex items-center gap-3">
              <HiExclamationTriangle className="w-5 h-5 text-amber-500 shrink-0" />
      ...
      {budgets.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 text-center">
          <HiChartBar className="w-12 h-12 text-gray-300 dark:text-gray-600 mx-auto mb-3" />
