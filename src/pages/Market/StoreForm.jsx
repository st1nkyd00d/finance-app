...
export default function StoreForm({ isOpen, onClose, onSave, initialData }) {
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Ej: Bicentenario, Central Madeirense..."
            autoFocus
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            maxLength={200}
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 outline-none"
            placeholder="Ej: cerca de casa, horario especial..."
          />
        </div>
